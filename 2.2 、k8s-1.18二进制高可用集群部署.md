...
[cni](https://github.com/containernetworking/plugins/releases/download/v0.8.7/cni-plugins-linux-amd64-v0.8.5.tgz)
...
```bash
for n in n{1..3};do scp cni-plugins-linux-amd64-v0.8.7.tgz $n:/root/ && ssh $n "tar -zxf cni-plugins-linux-amd64-v0.8.7.tgz -C /opt/cni/bin";done
```
