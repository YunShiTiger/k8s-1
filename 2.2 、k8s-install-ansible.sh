...
NODE_IP="10.0.0.41,10.0.0.42,10.0.0.43"
...
K8S_APISERVER_VIP="\"10.0.0.31\",\"10.0.0.32\",\"10.0.0.33\""
...
MASTER_IP=127.0.0.1
# 配置etcd 集群IP
ETCD_MEMBER_1_IP="10.0.0.31"
ETCD_MEMBER_1_HOSTNAMES="m1"
ETCD_MEMBER_2_IP="10.0.0.32"
ETCD_MEMBER_2_HOSTNAMES="m2"
ETCD_MEMBER_3_IP="10.0.0.33"
ETCD_MEMBER_3_HOSTNAMES="m3"
# etcd events集群 IP
ETCD_EVENTS_MEMBER_1_IP="10.0.0.41"
ETCD_EVENTS_MEMBER_1_HOSTNAMES="n1"
ETCD_EVENTS_MEMBER_2_IP="10.0.0.42"
ETCD_EVENTS_MEMBER_2_HOSTNAMES="n2"
ETCD_EVENTS_MEMBER_2_IP="10.0.0.43"
ETCD_EVENTS_MEMBER_2_HOSTNAMES="n3"
...
downloadK8S(){
   ...
   # 下载etcd
    ...
    # 下载kubernetes 
       wget -c  --tries=40  https://dl.k8s.io/${KUBERNETES_VERSION}/kubernetes-server-linux-amd64.tar.gz \
...
kubectlInstall(){
        ...
        if [[ ! -n `command -v kubectl` ]]; then       
             wget -c  --tries=40  https://dl.k8s.io/${KUBERNETES_VERSION}/kubernetes-client-linux-amd64.tar.gz \
...
cfsslInstall(){ 
         ...
         if [[ ! -n `command -v cfssl` ]]; then
            wget -c  --tries=40 https://pkg.cfssl.org/R1.2/cfssl_linux-amd64 -O $DOWNLOAD_PATH/cfssl
              if [[ $? -ne 0 ]]; then
         ...
         if [[ ! -n `command -v cfssljson` ]]; then
             wget -c  --tries=40 https://pkg.cfssl.org/R1.2/cfssljson_linux-amd64 -O $DOWNLOAD_PATH/cfssljson
                  if [[ $? -ne 0 ]]; then
