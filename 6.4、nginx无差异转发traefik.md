...
log_format main '{"time": "$time_iso8601", '
    ...
    client_max_body_size 102400m; #限制请求体的大小，若超过所设定的大小，返回413错误。
...
server {
    ...
    location / {
        #proxy_connect_timeout 5m; #等待的最长时间，默认为60秒
        #proxy_read_timeout 5m; #服务器响应时间，默认60秒
        #proxy_send_timeout 5m; #http请求被服务器处理完后，把数据传返回给Nginx的用时，默认60秒
