...
| :------: | :-------: | :------: | :--: | ---- | :------------------------------------------------------: |
|  master  | 10.0.0.31 |    m1    |  4   | 8G   | etcd  apiserver scheduler controller kubelet kube-proxy  |
|  master  | 10.0.0.32 |    m2    |  4   | 8G   | etcd  apiserver scheduler controller  kubelet kube-proxy |
|  master  | 10.0.0.33 |    m3    |  4   | 8G   | etcd  apiserver scheduler controller kubelet kube-proxy  |
|   node   | 10.0.0.41 |    n1    |  4   | 8G   |                    kubelet kube-proxy                    |
|   node   | 10.0.0.42 |    n2    |  4   | 8G   |                    kubelet kube-proxy                    |
|   node   | 10.0.0.43 |    n3    |  4   | 8G   |                    kubelet kube-proxy                    |
...
```bash
for n in 10.0.0.3{1..3}; do scp /root/.bash_profile $n:/root;done
```
