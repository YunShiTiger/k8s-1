Kubernetes架构图![k8s架构图](https://raw.githubusercontent.com/wzxmt/images/master/img/k8s架构图.png)
...
- kube-proxy负责为Service提供cluster内部的服务发现和负载均衡,负责写入规则至 IPTABLES、IPVS 实现服务映射访问的；
