...
[docker](https://download.docker.com/linux/static/stable/x86_64/docker-19.03.15.tgz)
...
EOF
cfssl gencert -ca=ca.pem -ca-key=ca-key.pem -config=ca-config.json -hostname=kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,172.16.0.1,10.96.0.1,127.0.0.1,10.0.0.180 -profile=kubernetes server-csr.json|cfssljson -bare server
```
