...
| :------: | :--------: | :------: | :--: | ---- | :----------------------------------------------------------: |
|  k8s01   | 10.0.0.180 |  k8s01   |  4   | 8G   | etcd  apiserver scheduler controller  kubectl  containerd kubelet kube-proxy |
|  k8s02   | 10.0.0.181 |  k8s02   |  4   | 8G   | etcd  apiserver scheduler controller  kubectl  containerd kubelet kube-proxy |
|  k8s03   | 10.0.0.182 |  k8s03   |  4   | 8G   | etcd  apiserver scheduler controller  kubectl  containerd kubelet kube-proxy |
...
ETCD_ENDPOINTS="etcd-k8s01=https://10.0.0.180:2380,etcd-k8s02=https://10.0.0.181:2380,etcd-k8s03=https://10.0.0.182:2380"
...
```bash
[root@k8s01 ~]# kubectl get pod,svc,ep
...
```bash
[root@k8s01 ~]# curl 10.96.232.171
Hello MyApp | Version: v2 | <a href="hostname.html">Pod Name</a>

[root@k8s01 ~]# curl 172.16.180.2
Hello MyApp | Version: v2 | <a href="hostname.html">Pod Name</a>
```
...
cat << EOF >/run/flannel/subnet.env
FLANNEL_NETWORK=172.16.0.0/16
FLANNEL_SUBNET=172.16.200.1/24
FLANNEL_MTU=1450
FLANNEL_IPMASQ=true
EOF
```
