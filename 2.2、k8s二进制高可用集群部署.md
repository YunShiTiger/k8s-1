...
EOF
cfssl gencert -ca=ca.pem -ca-key=ca-key.pem -config=ca-config.json -hostname=kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,172.16.0.0/16,10.96.0.0/16,127.0.0.1,${MASTER_CLUSTER_IP} -profile=kubernetes server-csr.json|cfssljson -bare server
```
